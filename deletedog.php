        ...
        if (!$con){
            ...
            if (!mysqli_select_db($con, 'store')){
               ...
               $form_id= filter_input(INPUT_POST, 'id');
                ...
                if ($form_id != null) {
                $sql="DELETE FROM dog WHERE d_id='$form_id' ";
...
<head>
    ...
    <script type="text/javascript">
        function dvalidation(){
           var did = document.forms["deleteform"]["id"].value;
           var ddelete = document.forms["deleteform"]["delete"].value;
  ...
  <div class="main">
    ...
    <table style="background-color: black; height: 200px; width: 200px">
        ...
        <tr>
            ...
            <div></div><div>
                  <div>
                      <button class="btn"><a href="deletecat.php">Go for cat? Click Here</a></button>
        </div>
            </div>
          </div>
    </div>
