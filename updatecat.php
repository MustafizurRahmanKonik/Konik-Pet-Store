<?php
        ...
        if (!$con){
            ...
            if (!mysqli_select_db($con, 'store')){
                ...
                $sql="UPDATE cat SET c_name='$form_name' WHERE c_id='$form_id' ";
                ...
                $sql1="UPDATE cat SET c_price='$form_price' WHERE c_id='$form_id' ";
                ...
                $sql2="UPDATE cat SET c_food='$form_food' WHERE c_id='$form_id' ";
...
<head>
    ...
    <script type="text/javascript">
        function uvalidation(){
           var cname= document.forms["updateform"]["name"].value;
           var cid = document.forms["updateform"]["id"].value;
           var cfood = document.forms["updateform"]["food"].value;
         
           var cprice = document.forms["updateform"]["price"].value;
           
           var cupdate = document.forms["updateform"]["update"].value;
  ...
  <div class="main">
    ...
    <div class="content">
        <div class="container">
            <center>
                <div class="formup">
                <form action="" method="POST" style="height:50px;width:50px;" id="updateform">
    <table style="background-color: black; height: 200px; width: 200px">
        ...
        <tr>
            ...
            <div></div><div>
                  <div>
                      <button class="btn"><a href="updatedog.php">Go for Dog? Click Here</a></button>
        </div>
            </div>
          </div>
    </div>
