<?php
        ...
        if (!$con){
            ...
            if (!mysqli_select_db($con, 'store')){
                ...
                $sql="insert into cat(c_id, c_name, c_price, c_food)
...
<head>
    ...
    <script type="text/javascript">
        function ivalidation(){
           var cname= document.forms["insertform"]["name"].value;
           var cid = document.forms["insertform"]["id"].value;
           var cfood = document.forms["insertform"]["food"].value;
         
           var cprice = document.forms["insertform"]["price"].value;
  ...
  <div class="main">
    ...
    <table style="background-color: black; height: 200px; width: 200px">
        ...
        <tr>
            ...
            <div></div><div>
                  <div>
                      <button class="btn"><a href="insertdog.php">Go for Dog? Click Here</a></button>
        </div>
            </div>
          </div>
    </div>
