...
<div class="content">
  <body>
    ...
    <figcaption>Green and Black Flowers</figcaption>
     ...
     <figure>
     <img src="Photos/c5.jpg">
    <figcaption>Yellow Button-Up</figcaption>
      <span class="price">$44</span>
      <form action="csearch/search5.php" method="POST">
      <input type="hidden" id="c05" name="c05" value="c05">
      <a class="button" href=""><input type="submit" id="buy1" value="Buy" class="button" /></a>
      </form>
    </figure>
    ...
    <figure>
    <img src="Photos/c7.jpg">
    <figcaption>Polka Dots</figcaption>
      <span class="price">$44</span>
      <form action="csearch/search7.php" method="POST">
      <input type="hidden" id="c07" name="c07" value="c07">
      <a class="button" href=""><input type="submit" id="buy1" value="Buy" class="button" /></a>
      </form>
    </figure>	
    ...
    <figcaption>Yellow Button-Up</figcaption>
     ...
     <figure>
    <img src="Photos/c8.jpg">
    <figcaption>Blue Spots</figcaption>
       <span class="price">$44</span>
       <form action="csearch/search8.php" method="POST">
      <input type="hidden" id="c08" name="c08" value="c08">
      <a class="button" href=""><input type="submit" id="buy1" value="Buy" class="button" /></a>
      </form>
    </figure>
    ...
    <figcaption>Polka Dots</figcaption>
      ...
      <figure>
    <img src="Photos/c9.jpg">
      <figcaption>Pink Dots</figcaption>
        <span class="price">$44</span>
        <form action="csearch/search9.php" method="POST">
      <input type="hidden" id="c09" name="c09" value="c09">
      <a class="button" href=""><input type="submit" id="buy1" value="Buy" class="button" /></a>
      </form>
    </figure>	
    ...
    <img src="Photos/d9.jpg">
      ...
      <a class="button" href=""><input type="submit" id="buy" value="Buy" class="button" /></a>
          ...
          <div class="cont">
             <div class="page">
                 <a href="afterlogin.php"><button class="btn1" onclick="backBtn()"> <img src="448-arrow.png"> prev</button></a>
            <ul  class="ing">
                <a href="afterlogin.php"><li class="link" value="1" onclick="activeLink()">1</li></a>
                <li class="link active" value="2" onclick="activeLink()"><a href="#">2</a></li>
