...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
        <div class="container">
            <center>
                <h4 style="background-color: #d8e2dc; text-align: center; text-decoration: scrollbar;text-height: 60px;">
                    <p style="font-size: 300%; font-family: sans-serif; color: #d00000">Konik Pet Store - KPS<br>
                        Want a true Bestfriend? Here we provide you the bestfriend you desire. You can have dog/cat at a reasonable price here.</p>
                </h4>
            </center>
          </div>
    </div>
